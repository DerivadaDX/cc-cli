...
public class IndividuoIntercambioAsignacionesFactoryTests
{
    [Fact]
    public void CrearAleatorio_InstanciaDevuelta_EsDelTipoCorrecto()
    {
        ...
        var individuoFactory = new IndividuoIntercambioAsignacionesFactory(problema);
    ...
    public void CrearAleatorio_CromosomaDeInstanciaDevuelta_LongitudCorrecta()
    {
        ...
        int longitudCromosomaEsperada = 9; // 4 cortes + 5 asignaciones (5 agentes)
