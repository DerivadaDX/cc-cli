...
internal abstract class IndividuoLegacy : Individuo
{
    private readonly CalculadoraFitness _calculadoraFitness;

    protected IndividuoLegacy(List<int> cromosoma, InstanciaProblema problema, GeneradorNumerosRandom generadorRandom)
